...
<div class="container-fluid">
    ...
    <!-- <div class="row justify-content-center">
                <p class="text-dark text-center">Selamat datang <?= $masyarakat['nama_lengkap'] ?> di website NGADUIN, website NGADUIN ini akan membantu <?= $masyarakat['nama_lengkap'] ?> dalam melaporkan peristiwa atau kejadian yang ada di sekitar <?= $masyarakat['nama_lengkap'] ?>. <br>Sampaikan laporan <?= $masyarakat['nama_lengkap'] ?> langsung kepada instansi pemerintah yang berwenang</p>
